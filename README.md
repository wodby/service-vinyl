# Vinyl service for Wodby

Use Vinyl as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Vinyl service in the Wodby catalog.

- [Vinyl service in the Wodby catalog](https://wodby.com/services/vinyl)
...
4. Reference `vinyl` from your stack manifest.
